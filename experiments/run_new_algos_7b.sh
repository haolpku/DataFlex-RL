...
declare -A RUN
RUN[gfpo]="$DFsync +dataflex.mechanism=select +dataflex.scorer.name=reward_difficulty +dataflex.actuator.name=gfpo +dataflex.actuator.params.k=8 +dataflex.actuator.params.metric=efficiency +dataflex.warmup_step=0"
