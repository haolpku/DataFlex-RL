#!/usr/bin/env bash
# 7B GRPO training driver — jizhicfs / H20 version (multi-seed campaign, Paper 2).
# Mirrors DataFlex-RL/experiments/train_one_7b.sh but rooted at /jizhicfs/aldenliang.
# Only the DataFlex block ($DF_ARGS) and SEED vary between runs.
set -xeuo pipefail
...
CKPT_ROOT=${CKPT_ROOT:-$ROOT/df_ckpts_7b_seeds}
